(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const o of t)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function a(t){const o={};return t.integrity&&(o.integrity=t.integrity),t.referrerPolicy&&(o.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?o.credentials="include":t.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(t){if(t.ep)return;t.ep=!0;const o=a(t);fetch(t.href,o)}})();const v={title:"An Interview with 4EVA",tags:["interview"],content:`	
    ...
    `,visible:!1},p=Object.freeze(Object.defineProperty({__proto__:null,default:v},Symbol.toStringTag,{value:"Module"})),f={title:"Into The Vortex 2025",tags:["event","oasis"],post_date:"2025-06-14",content:`Into The Vortex, Mar 7-9 2025.
    `,visible:!0,image:"ext_assets/events/Into The Vortex/doco/20250308_071350.jpg"},b=Object.freeze(Object.defineProperty({__proto__:null,default:f},Symbol.toStringTag,{value:"Module"})),m={title:"Oasis 2025",tags:["upcoming","event","oasis"],post_date:"2025-06-14",content:`Oasis is back for 2025!
 ...
 We are a network of live digital artists, and this is our blog.
  ...
  `};console.log("Running in production mode");const g=Object.values([p,b,_,y,k,$,O]).map(e=>e.default).filter(e=>e!==void 0),j=g.filter(e=>e.visible!==!1);g.forEach(e=>{console.log(`Loaded post: ${e.title} (visible: ${e.visible})`)});const M=["upcoming","event","interview","software"];let s=new Set,r="about";function T(){return`
    <nav class="main-nav">
  ...
  `}function l(){const e=document.querySelector("#app");let n="";if(r==="about"?n=H():r==="network"?n=L():n=`
